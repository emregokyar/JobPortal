...
public interface JobPostActivityRepository extends JpaRepository<JobPostActivity, Integer> {
    ...
    //Retrieving list of jobs that recruiter posts, counts them and fetch them additional info
    ...
    List<IRecruiterJobs> getRecruiterJobs(@Param("recruiter") int recruiter); //It retrieves and patches all the info into given class as a list - Spring will match names in the given part
